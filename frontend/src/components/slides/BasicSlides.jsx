  ...
  <div className="w-full flex items-center justify-center px-8">
    <div className="relative w-full max-w-4xl">
      ...
      <div className="text-center py-16 px-12 animate-fadeIn">
        ...
        <h1
          className="text-7xl md:text-8xl font-normal text-[#3E2C1E] leading-tight"
          style={{ fontFamily: "'Cormorant Garamond', serif" }}
        >
          {data.title}
        </h1>
        <p
          className="mt-5 text-3xl italic text-[#5C4A38]"
          style={{ fontFamily: "'Cormorant Garamond', serif" }}
        >
          {data.subtitle}
        </p>
        <div className="flex justify-center"><Ornament /></div>
        <p className="mt-4 text-xl text-[#4A3728]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          {data.description}
        </p>
        <p className="mt-6 text-[14px] tracking-[0.4em] uppercase text-[#8B2020] font-sans font-medium">
          {data.author}
        </p>
        <p
          className="mt-6 text-lg italic text-[#7A6A55] max-w-2xl mx-auto leading-relaxed"
          style={{ fontFamily: "'Cormorant Garamond', serif" }}
        >
          {data.dedication}
        </p>
        <p className="mt-8 text-[12px] tracking-[0.35em] uppercase text-[#B8985C] font-sans">
          01 &middot; 57
        </p>
      </div>
    </div>
...
export const SectionTitleSlide = ({ data }) => (
  <div className="w-full flex items-center justify-center px-8">
    <div className="text-center max-w-4xl animate-fadeIn">
      <div className="flex justify-center"><Ornament /></div>
      <p className="text-[13px] tracking-[0.4em] uppercase text-[#B8985C] font-sans font-medium mt-2">
        {data.section}
      </p>
      <h1
        className="mt-6 text-6xl md:text-7xl font-normal text-[#3E2C1E] leading-tight"
        style={{ fontFamily: "'Cormorant Garamond', serif" }}
      >
        {data.title}
      </h1>
      {data.subtitle && (
        <p
          className="mt-5 text-2xl italic text-[#5C4A38]"
          style={{ fontFamily: "'Cormorant Garamond', serif" }}
        >
          {data.subtitle}
        </p>
...
export const ContentSlide = ({ data }) => (
  <div className="w-full flex items-center justify-center px-8">
    <div className="max-w-4xl w-full animate-fadeIn">
      ...
      <Ornament width={160} />
      <div
        className="mt-6 space-y-6 text-[22px] leading-[1.75] text-[#4A3728]"
        style={{ fontFamily: "'Cormorant Garamond', serif" }}
      >
...
export const ClosingSlide = ({ data }) => (
  <div className="w-full flex items-center justify-center px-8">
    <div className="text-center max-w-3xl animate-fadeIn">
      ...
      <div className="flex justify-center"><Ornament /></div>
      <h1
        className="text-7xl md:text-8xl font-normal text-[#3E2C1E]"
        style={{ fontFamily: "'Cormorant Garamond', serif" }}
      >
        {data.title}
      </h1>
      <div className="flex justify-center"><Ornament /></div>
      <div
        className="mt-5 space-y-5 text-2xl italic text-[#5C4A38] leading-relaxed"
        style={{ fontFamily: "'Cormorant Garamond', serif" }}
      >
        {data.paragraphs.map((p, i) => (
          <p key={i}>{p}</p>
      ...
      <p className="mt-10 text-[14px] tracking-[0.4em] uppercase text-[#8B2020] font-sans font-medium">
        {data.author}
      </p>
      <p
        className="mt-3 text-xl italic text-[#7A6A55]"
        style={{ fontFamily: "'Cormorant Garamond', serif" }}
      >
        {data.farewell}
      </p>
